...
func TestCloudSecurityComplianceFrameworkDeploymentIdentity_FromExternal(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ref:  "organizations/my-org/locations/global/frameworkDeployments/my-deployment",
			want: &CloudSecurityComplianceFrameworkDeploymentIdentity{
				Organization:        "my-org",
				Location:            "global",
		...
		{
			name: "full url",
			ref:  "https://cloudsecuritycompliance.googleapis.com/organizations/my-org/locations/global/frameworkDeployments/my-deployment",
			want: &CloudSecurityComplianceFrameworkDeploymentIdentity{
				Organization:        "my-org",
				Location:            "global",
				FrameworkDeployment: "my-deployment",
