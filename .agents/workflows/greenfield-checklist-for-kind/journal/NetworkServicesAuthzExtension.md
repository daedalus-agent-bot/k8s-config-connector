...
|------|------|--------------|---------------------|--------|--------------|----------------|
| 1 | Direct API Types and Identity | [#10292](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/10292) | [#10339](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/10339) (Closed) | Open | 2026-06-15 | - |
