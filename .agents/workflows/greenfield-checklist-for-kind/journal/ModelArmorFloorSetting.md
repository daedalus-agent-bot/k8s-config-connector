...
|------|------|--------------|---------------------|--------|--------------|----------------|
| 1    | Direct KRM Types, Identity & Reference | [#12748](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/12748) | [#11615](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/11615) | PR Created | 2026-09-03 | |
