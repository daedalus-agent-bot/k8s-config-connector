...
|------|------|--------------|---------------------|--------|--------------|----------------|
| 1    | Direct API Types, Identity & Refs | [#12912](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/12912) | [#12914](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/12914) | PR Created | 2026-09-11 | |
