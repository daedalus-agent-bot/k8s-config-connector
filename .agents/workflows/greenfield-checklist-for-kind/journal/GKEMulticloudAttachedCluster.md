...
|---|---|---|---|---|---|---|
| 1 | Direct API Types and Identity / Refs Pattern | [#10273](https://github.com/GoogleCloudPlatform/k8s-config-connector/issues/10273) | [#11264](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/11264) | CI In Progress | 2026-06-15 | - |
